                ...
                >
                    ...
                    >
                        ...
                        <nav class="px-3 pb-20">
                            ...
                            <div class="px-3 pb-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button
                                        @click="toggleDarkMode"
                                        class="relative inline-flex items-center h-8 w-16 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                                        :class="isDark ? 'bg-gray-600' : 'bg-blue-500'"
                                    ...
                                    >
                                        ...
                                        <!-- Slider with Icon -->
                                        <span
                                            class="absolute inline-flex items-center justify-center left-0.5 h-6 w-6 rounded-full bg-white shadow-lg transform transition-all duration-500 ease-in-out"
                                            :class="isDark ? 'translate-x-[34px] rotate-[360deg]' : 'translate-x-0 rotate-0'"
                                        >
                                            <!-- Sun Icon (Light Mode) -->
                                            <svg
                                                v-if="!isDark"
                                                class="w-4 h-4 text-yellow-500 transition-transform duration-500"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                                                <path
                                            ...
                                            <svg
                                                v-else
                                                class="w-4 h-4 text-gray-700 transition-transform duration-500"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                                        ...
                                        <div class="absolute inset-0 flex items-center pointer-events-none">
                                            <!-- Moon background icon (shows in light mode - right side) -->
                                            <svg
                                                class="absolute w-3.5 h-3.5 right-2 transition-opacity duration-300"
                                                :class="!isDark ? 'opacity-60 text-gray-400' : 'opacity-0'"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                                                <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
                                            </svg>
                                            <!-- Sun background icon (shows in dark mode - left side) -->
                                            <svg
                                                class="absolute w-3.5 h-3.5 left-2 transition-opacity duration-300"
                                                :class="isDark ? 'opacity-60 text-yellow-300' : 'opacity-0'"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
                                                <path
