            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        >
                            <img
                                ...
                                :class="{
                                    'ring-2 ring-blue-500': image.is_primary,
                                }"
                            />
                            <span
                            ...
                            <button
                                ...
                                :class="{
                                    'bg-gray-500': imagesToDelete.includes(
                                        image.id
                                    ),
                                }"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        />
                        <p class="mt-1 text-sm text-gray-500">
                            Upload up to 5 images total (JPEG, PNG, GIF, WebP -
                            Max 2MB each)
                        </p>
                    </div>
                    <p
...
const handleImageChange = (event) => {
    ...
    const currentImageCount =
        (props.product.images?.length || 0) - imagesToDelete.value.length;
