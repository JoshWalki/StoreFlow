<template>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto bg-gray-900 bg-opacity-90">
        <div class="flex min-h-screen items-center justify-center p-4">
            <div
                class="relative w-full max-w-3xl transform rounded-lg bg-white dark:bg-gray-800 shadow-2xl transition-all"
            >
                <!-- Header -->
                <div
                ...
                >
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            >
                                Let's create your first store to get started
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div
                        class="max-h-[calc(100vh-300px)] overflow-y-auto px-6 py-6"
                    >
                        <!-- Store Name (Required) -->
                        <div class="mb-6">
                            <label
