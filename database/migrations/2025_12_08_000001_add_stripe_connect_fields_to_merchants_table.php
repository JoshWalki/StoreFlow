...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('merchants', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_connect_account_id')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_onboarding_complete')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_charges_enabled')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_payouts_enabled')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_details_submitted')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_requirements')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_country')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_verified_at')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_subscription_id')) {
            ...
            if (!Schema::hasColumn('merchants', 'stripe_customer_id')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_plan_id')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_current_period_start')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_current_period_end')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_trial_end')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_cancel_at_period_end')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_canceled_at')) {
            ...
            if (!Schema::hasColumn('merchants', 'subscription_ended_at')) {
            ...
            if (!Schema::hasColumn('merchants', 'platform_fee_percentage')) {
            ...
            if (!Schema::hasColumn('merchants', 'platform_fee_fixed_cents')) {
        ...
        Schema::table('merchants', function (Blueprint $table) {
            $indexes = DB::select("SHOW INDEX FROM merchants WHERE Key_name IN ('idx_merchants_stripe_connect', 'idx_merchants_stripe_customer', 'idx_merchants_subscription_status', 'idx_merchants_subscription_active')");
            $existingIndexes = array_column($indexes, 'Key_name');

            if (!in_array('idx_merchants_stripe_connect', $existingIndexes)) {
                $table->index('stripe_connect_account_id', 'idx_merchants_stripe_connect');
            }
            if (!in_array('idx_merchants_stripe_customer', $existingIndexes)) {
                $table->index('stripe_customer_id', 'idx_merchants_stripe_customer');
            }
            if (!in_array('idx_merchants_subscription_status', $existingIndexes)) {
                $table->index('subscription_status', 'idx_merchants_subscription_status');
            }
            if (!in_array('idx_merchants_subscription_active', $existingIndexes)) {
